...
static inline bool zwp_text_input_v3_change_cause_is_valid(uint32_t value,
                                                           uint32_t version) {
  switch (value) {
...
static inline bool zwp_text_input_v3_content_hint_is_valid(uint32_t value,
                                                           uint32_t version) {
  uint32_t valid = 0;
  if (version >= 1)
...
struct zwp_text_input_v3_interface {
  ...
  void (*enable)(struct wl_client *client, struct wl_resource *resource);
...
static inline void zwp_text_input_v3_send_enter(struct wl_resource *resource_,
                                                struct wl_resource *surface) {
  wl_resource_post_event(resource_, ZWP_TEXT_INPUT_V3_ENTER, surface);
}

static inline void zwp_text_input_v3_send_leave(struct wl_resource *resource_,
                                                struct wl_resource *surface) {
...
zwp_text_input_v3_send_preedit_string(struct wl_resource *resource_,
                                      ...
                                      int32_t cursor_end) {
  wl_resource_post_event(resource_, ZWP_TEXT_INPUT_V3_PREEDIT_STRING, text,
...
static inline void zwp_text_input_v3_send_done(struct wl_resource *resource_,
                                               uint32_t serial) {
...
struct zwp_text_input_manager_v3_interface {
  ...
  void (*get_text_input)(struct wl_client *client, struct wl_resource *resource,
