...
static inline bool wl_display_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_shm_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_shm_format_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_data_offer_error_is_valid(uint32_t value,
                                                uint32_t version) {
  switch (value) {
...
static inline bool wl_data_source_error_is_valid(uint32_t value,
                                                 uint32_t version) {
  switch (value) {
...
static inline bool wl_data_device_error_is_valid(uint32_t value,
                                                 uint32_t version) {
  switch (value) {
...
static inline bool wl_shell_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_shell_surface_resize_is_valid(uint32_t value,
                                                    uint32_t version) {
  uint32_t valid = 0;
  if (version >= 1)
...
static inline bool wl_shell_surface_transient_is_valid(uint32_t value,
                                                       uint32_t version) {
  uint32_t valid = 0;
  if (version >= 1)
...
static inline bool wl_surface_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline void
wl_surface_send_preferred_buffer_scale(struct wl_resource *resource_,
                                       int32_t factor) {
  wl_resource_post_event(resource_, WL_SURFACE_PREFERRED_BUFFER_SCALE, factor);
}

static inline void
wl_surface_send_preferred_buffer_transform(struct wl_resource *resource_,
                                           uint32_t transform) {
...
static inline bool wl_seat_capability_is_valid(uint32_t value,
                                               uint32_t version) {
  uint32_t valid = 0;
  if (version >= 1)
...
static inline bool wl_seat_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_pointer_error_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_pointer_button_state_is_valid(uint32_t value,
                                                    uint32_t version) {
  switch (value) {
...
static inline bool wl_pointer_axis_is_valid(uint32_t value, uint32_t version) {
  switch (value) {
...
static inline bool wl_pointer_axis_source_is_valid(uint32_t value,
                                                   uint32_t version) {
  switch (value) {
...
static inline void
wl_pointer_send_axis_relative_direction(struct wl_resource *resource_,
...
static inline bool wl_keyboard_keymap_format_is_valid(uint32_t value,
                                                      uint32_t version) {
  switch (value) {
...
static inline bool wl_keyboard_key_state_is_valid(uint32_t value,
                                                  uint32_t version) {
  switch (value) {
...
static inline bool wl_output_subpixel_is_valid(uint32_t value,
                                               uint32_t version) {
  switch (value) {
...
static inline bool wl_output_transform_is_valid(uint32_t value,
                                                uint32_t version) {
  switch (value) {
...
static inline bool wl_output_mode_is_valid(uint32_t value, uint32_t version) {
  uint32_t valid = 0;
  if (version >= 1)
...
static inline void
wl_output_send_geometry(struct wl_resource *resource_, int32_t x, int32_t y,
...
static inline bool wl_subcompositor_error_is_valid(uint32_t value,
                                                   uint32_t version) {
  switch (value) {
...
static inline bool wl_subsurface_error_is_valid(uint32_t value,
                                                uint32_t version) {
  switch (value) {
